   ...
   public  class WordCPageOperate
    {
        ...
        public void PageSizeC(WordQuestionEntity wordinfo)
        {
            //将正确答案、分值取出来，传给dt
        ...
        /// </summary>
        /// <param name="wordinfo"></param>
        public void PageMarginUpOperateC(WordQuestionEntity wordinfo)
        {
        ...
        /// </summary>
        /// <param name="wordinfo"></param>
        public void HeaderFootOperateC(WordQuestionEntity wordinfo)
        {
            //将正确答案、分值取出来，传给dt
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                ...
                //将得分传递到studentrecord实体
                //如果页的左右边距和数据库中的一样
                if (app.ActiveDocument.PageSetup.HeaderDistance== float.Parse(dt.Rows[i]["RightAnswer"].ToString()))
                {
                    //加分
                    studentrecord.Fration = fration;
                }
