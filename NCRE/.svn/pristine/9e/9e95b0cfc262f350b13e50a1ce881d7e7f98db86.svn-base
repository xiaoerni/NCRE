...
{
    public class ExcelFontColor
    {
        private ExcelEntityBLL excelquestionblfontcolor = new ExcelEntityBLL();
        #region 字体颜色——王虹芸
        public void FontColor(ExcelQuestionEntity excelinfo)
        {
            //将正确答案、分值取出来，传给dt
            excelinfo.QuestionFlag = "字体颜色";
            DataTable dt = excelquestionblfontcolor.QueryExcelTypeID(excelinfo);
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                ...
                try
                {
                    ...
                    string fontcolor = ExcelJudgeHelper.m_excel.Range[x].Font.Color.ToString();

                    excelrecord.ExamAnswer = fontcolor;
                }
                catch { } 
                ...
                excelquestionblfontcolor.ReturnExcelScore(excelrecord);
            }
        }
        #endregion
    }
