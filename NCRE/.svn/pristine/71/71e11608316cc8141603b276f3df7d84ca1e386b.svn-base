...
namespace NCRE学生考试端V1._0
{
    class WindowsReadOnly
    {
        ...
        #region"只读-韩梦甜-2015-11-20"
        /// <summary>
        /// 只读
        /// </summary>
        /// <param name="winquestion"></param>
        public void ReadOnly(WinQuestionEntity winquestion)
        {
            //将正确答案，分值取出来，传给studentRecord
           
            winquestion.questionFlag = "只读";
            ...
            for (int i = 0; i < winQuestionDt.Rows.Count; i++)
            {
                ...
                //查看只读属性
                if (File.GetAttributes(str).ToString().IndexOf("ReadOnly")!=-1)
