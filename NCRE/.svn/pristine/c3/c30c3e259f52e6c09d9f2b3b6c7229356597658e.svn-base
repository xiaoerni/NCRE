...
namespace NCRE学生考试端V1._0
{
    class WordGPageOperate
    {
        ...
        #region 李少然 上下页边距  2015年12月9日19:16:47
      /// <summary>
      /// 页边距上下
      /// </summary>
      /// <param name="wordinfo"></param>
        public void PageMarginUpOperateG(WordQuestionEntity wordinfo)
        {
       ...
       /// </summary>
       /// <param name="wordinfo"></param>
        public void PageMarginLeftOperateG(WordQuestionEntity wordinfo)
        {
        ...
        public void PageSizeG(WordQuestionEntity wordinfo)
        {
        ...
        /// </summary>
        /// <param name="wordinfo">题库实体</param>
        public void PageMarginTopOperateG(WordQuestionEntity wordinfo)
        {
        ...
        /// </summary>
        /// <param name="wordinfo">题库实体</param>
        public void PageHeaderTextG(WordQuestionEntity wordinfo)
        {
            //将正确答案、分值取出来，传给dt
            ...
            else
            {
                ...
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    studentrecord.StudentID = FrmLogin.studentID;
                    //将考生答案的页眉页脚边距边距传递给studentrecord实体 
                    studentrecord.ExamAnswer = allRange.Sections[1].Headers[WdHeaderFooterIndex.wdHeaderFooterPrimary].Range.Text.Substring(0, 7);
                    //将试题的ID选择出来
                    studentrecord.QuestionID = Convert.ToDouble(dt.Rows[i]["QuestionID"]);
                    //将每道题的分值取出
                    fration = dt.Rows[i]["Fration"].ToString();
                    ...
                    //将得分传递到studentrecord实体
                    //如果页的页眉页脚边距和数据库中的一样
                    if (allRange.Sections[1].Headers[WdHeaderFooterIndex.wdHeaderFooterPrimary].Range.Text.Substring(0, 7) == dt.Rows[i]["RightAnswer"].ToString())
                    {
                        //加分
                        studentrecord.Fration = fration;
                    }
        ...
        /// </summary>
        /// <param name="wordinfo">题库实体</param>
        public void PageFontG(WordQuestionEntity wordinfo)
        {
            //将正确答案、分值取出来，传给dt
        ...
        /// </summary>
        /// <param name="wordinfo">题库实体</param>
        public void PageFontSizeG(WordQuestionEntity wordinfo)
        {
            //将正确答案、分值取出来，传给dt
        ...
        /// </summary>
        /// <param name="wordinfo">题库实体</param>
        public void PageHeaderFormatG(WordQuestionEntity wordinfo)
        {
            //将正确答案、分值取出来，传给dt
