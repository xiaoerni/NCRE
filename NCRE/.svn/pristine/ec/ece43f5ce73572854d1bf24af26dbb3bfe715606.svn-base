...
namespace NCRE学生考试端V1._0
{
    ...
    {
        private ExcelEntityBLL excelquestionblcellwidth = new ExcelEntityBLL();
        #region 指定位置单元格列宽——王虹芸

        public void CellWidth(ExcelQuestionEntity excelinfo)
        {
            //将正确答案、分值取出来，传给dt
            excelinfo.QuestionFlag = "列宽";
            DataTable dt = excelquestionblcellwidth.QueryExcelTypeID(excelinfo);
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                ...
                try
                {
                    ...
                    string columnwidth = ExcelJudgeHelper.m_excel.Range[x].ColumnWidth.ToString();
                    excelrecord.ExamAnswer = columnwidth;
                }
                catch { } 
                ...
                excelquestionblcellwidth.ReturnExcelScore(excelrecord);
            }
        }
        #endregion
    }
