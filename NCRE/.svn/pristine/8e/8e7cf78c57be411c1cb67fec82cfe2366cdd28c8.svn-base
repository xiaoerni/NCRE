...
{
    public class ExcelHorizonAlignment
    {
        private ExcelEntityBLL excelquestionblhorizonalignment = new ExcelEntityBLL();
        
        #region 单元格水平对齐方式——王虹芸
        public void HorizonAlinment(ExcelQuestionEntity excelinfo)
        {
            //将正确答案、分值取出来，传给dt
            excelinfo.QuestionFlag = "单元格水平对齐方式";
            System.Data.DataTable dt = excelquestionblhorizonalignment.QueryExcelTypeID(excelinfo);
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                ...
                try
                {
                    ...
                    excelrecord.ExamAnswer = ExcelJudgeHelper.m_excel.Range[firstNum, secondNum].HorizontalAlignment.ToString();
                }
                catch { }
                ...
                excelquestionblhorizonalignment.ReturnExcelScore(excelrecord);
            }
        }
        #endregion
    }
