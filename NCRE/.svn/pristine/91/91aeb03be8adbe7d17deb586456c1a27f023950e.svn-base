...
{
    public class ExcelFontSize
    {
        private ExcelEntityBLL excelquestionblfontsize = new ExcelEntityBLL();

        #region 字体大小——王虹芸
        public void FontSize(ExcelQuestionEntity excelinfo)
        {
            //将正确答案、分值取出来，传给dt
            excelinfo.QuestionFlag = "字体大小";
            DataTable dt = excelquestionblfontsize.QueryExcelTypeID(excelinfo);
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                ...
                try
                {
                    ...
                    string fontsize = ExcelJudgeHelper.m_excel.Range[x].Font.Size.ToString();

                    excelrecord.ExamAnswer = fontsize;
                }
                catch { } 
                ...
                excelquestionblfontsize.ReturnExcelScore(excelrecord);
            }
