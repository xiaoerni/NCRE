...
namespace NCRE学生考试端V1._0
{
    class WordEPageOperate
    {
      ...
      /// <param name="wordinfo"></param>
        public void PageMarginUpOperateE(WordQuestionEntity wordinfo)
        {
       ...
       /// </summary>
       /// <param name="wordinfo"></param>
        public void PageMarginLeftOperateE(WordQuestionEntity wordinfo)
        {
        ...
        public void PageSizeE(WordQuestionEntity wordinfo)
        {
        ...
        /// </summary>
        /// <param name="wordinfo">题库实体</param>
        public void PageMarginTopOperateE(WordQuestionEntity wordinfo)
        {
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                ...
                studentrecord.ExamAnswer = app.Selection.Paragraphs.Alignment.ToString();
                ...
                //将得分传递到studentrecord实体
                //如果页的页眉页脚边距和数据库中的一样
                if (app.Selection.Paragraphs.Alignment.ToString() == dt.Rows[i]["RightAnswer"].ToString())
                {
                    //加分
                    studentrecord.Fration = fration;
                }
        ...
        /// </summary>
        /// <param name="wordinfo">题库实体</param>
        public void PageHeaderTextE(WordQuestionEntity wordinfo)
        {
            //将正确答案、分值取出来，传给dt
        ...
        /// </summary>
        /// <param name="wordinfo">题库实体</param>
        public void PageHeaderFormatE(WordQuestionEntity wordinfo)
        {
            //将正确答案、分值取出来，传给dt
        ...
        #region 李少然 查找页码  2015年12月9日15:58:35
        /// <summary>
        /// 查找页码
        /// </summary>
        /// <param name="wordinfo">题库实体</param>
        public void SearchPageE(WordQuestionEntity wordinfo)
        {
            //将正确答案、分值取出来，传给dt
