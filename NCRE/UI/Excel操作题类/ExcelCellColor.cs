...
namespace NCRE学生考试端V1._0
{
    ...
    {
        private ExcelEntityBLL excelquestionblcellcolor = new ExcelEntityBLL();

        #region 列单元格颜色——王虹芸——修改来着的——11.25
        public void CellColor(ExcelQuestionEntity excelinfo)
        {
            //将正确答案、分值取出来，传给dt
            excelinfo.QuestionFlag  = "单元格颜色";
            DataTable dt = excelquestionblcellcolor.QueryExcelTypeID(excelinfo);
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                ...
                try
                {
                    ...
                    excelrecord.ExamAnswer = ExcelJudgeHelper.m_excel.Range[x, y].Interior.Color.ToString();
                }
                catch { }
                ...
                excelquestionblcellcolor.ReturnExcelScore(excelrecord);
            }
        }
        #endregion
