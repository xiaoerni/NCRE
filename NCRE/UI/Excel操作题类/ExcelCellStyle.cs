...
namespace NCRE学生考试端V1._0
{
    ...
    {
        private ExcelEntityBLL excelquestionblcellstyle = new ExcelEntityBLL();


        #region 单元格格式——王虹芸
        public void CellStyle(ExcelQuestionEntity excelinfo)
        {
            //将正确答案、分值取出来，传给dt
            excelinfo.QuestionFlag = "单元格格式";
            System.Data.DataTable dt = excelquestionblcellstyle.QueryExcelTypeID(excelinfo);
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                ...
                try
                {
                    ...
                    excelrecord.ExamAnswer = ExcelJudgeHelper.m_excel.Range[firstNum, secondNum].NumberFormatLocal.ToString();
                }
                catch { }
                ...
                excelquestionblcellstyle.ReturnExcelScore(excelrecord);
            }
        }
        #endregion
    }
