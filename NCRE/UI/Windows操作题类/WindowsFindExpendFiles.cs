...
{
    public class WindowsFindExpendFiles
    {
        private WinQuestionEntityBLL winquestionbll = new WinQuestionEntityBLL();

        #region"后缀名查找文件-韩梦甜-2015-11-23"
        /// <summary>
        /// 后缀名查找文件
        /// </summary>
        /// <param name="winquestion"></param>
        public void FindExpendFiles(WinQuestionEntity winquestion)
        {
            //将正确答案，分值取出来，传给studentRecord

            winquestion.questionFlag = "后缀名查找文件";
