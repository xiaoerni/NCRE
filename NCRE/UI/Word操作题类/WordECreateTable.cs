...
namespace NCRE学生考试端V1._0
{
    class WordECreateTable
    {
        ...
        private static object file = @"D:\计算机一级考生文件\Wordkt\bgE.docx";
        ...
        public void SetOtherLineHeightE(WordQuestionEntity wordinfo)
        {
        ...
        /// </summary>
        /// <param name="wordinfo"></param>
        public void SetFirstColWeightE(WordQuestionEntity wordinfo)
        {
            //将正确答案、分值取出来，传给dt
        ...
        /// </summary>
        /// <param name="wordinfo"></param>
        public void TableWordFormatE(WordQuestionEntity wordinfo)
        { //将正确答案、分值取出来，传给dt
        ...
        #region 李少然 表格文字型号 2015年12月9日16:17:09
        /// <summary>
        /// 表格文字型号
        /// </summary>
        /// <param name="wordinfo"></param>
        public void TableWordNameE(WordQuestionEntity wordinfo)
        { //将正确答案、分值取出来，传给dt
        ...
        #region 李少然 表格文字大小 2015年12月9日16:17:09
        /// <summary>
        /// 表格文字大小
        /// </summary>
        /// <param name="wordinfo"></param>
        public void TableWordSizeE(WordQuestionEntity wordinfo)
        { //将正确答案、分值取出来，传给dt
        ...
        public void TableBoldBolderE(WordQuestionEntity wordinfo)
        {
        ...
        /// </summary>
        /// <param name="studentinfo"></param>
        public void TableBoldBolderOutColorE(WordQuestionEntity wordinfo)
        {
        ...
        /// </summary>
        /// <param name="studentinfo"></param>
        public void TableInsideBoldBolderE(WordQuestionEntity wordinfo)
        {
            //将正确答案、分值取出来，传给dt
        ...
        /// </summary>
        /// <param name="studentinfo"></param>
        public void TableBoldBolderInColorE(WordQuestionEntity wordinfo)
        {
        ...
        #region  李少然 表格单行填充颜色 2015年12月9日16:22:50
        /// <summary>
        /// 表格内边框线颜色
        /// </summary>
        /// <param name="studentinfo"></param>
        public void TableSingelInColorE(WordQuestionEntity wordinfo)
        {

            //将正确答案、分值取出来，传给dt
            wordinfo.QuestionFlag = "表格单行填充颜色";
            DataTable dt = wordquestionbll.LoadWordByFlag(wordinfo);
            WordQuestionRecordEntity studentrecord = new WordQuestionRecordEntity();
        ...
        /// </summary>
        /// <param name="wordinfo"></param>
        public void TableWordFontFormatE(WordQuestionEntity wordinfo)
        { //将正确答案、分值取出来，传给dt
        ...
        /// </summary>
        /// <param name="wordinfo"></param>
        public void TableFormatE(WordQuestionEntity wordinfo)
        { //将正确答案、分值取出来，传给dt
