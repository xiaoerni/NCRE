...
namespace NCRE学生考试端V1._0
{
    public class WordBPageOperate
    {
        ...
        public void PageMarginUpOperateB(WordQuestionEntity wordinfo)
        {
         //将正确答案、分值取出来，传给dt
        ...
        /// </summary>
        /// <param name="wordinfo"></param>
        public void PageMarginLeftOperateB(WordQuestionEntity wordinfo)
        {
        ...
        /// </summary>
        /// <param name="wordinfo"></param>
        public void GutterPositionB(WordQuestionEntity wordinfo)
        {
            //将正确答案、分值取出来，传给dt
        ...
        /// </summary>
        /// <param name="wordinfo"></param>
        public void PageDirectionB(WordQuestionEntity wordinfo)
        {
        ...
        /// </summary>
        /// <param name="wordinfo"></param>
        public void PageSizeB(WordQuestionEntity wordinfo)
        {
        ...
        /// </summary>
        /// <param name="wordinfo"></param>
        public void FindPageNumB(WordQuestionEntity wordinfo)
        {
        ...
        /// </summary>
        /// <param name="wordinfo"></param>
        public void FindPictureB(WordQuestionEntity wordinfo)
        {
        ...
        /// </summary>
        /// <param name="wordinfo"></param>
        public void FindPictureHightB(WordQuestionEntity wordinfo)
        {
